...
// Маппинг slug модели → URL страницы услуги
$model_url_map = [
    'iphone-6'          => '/service/remont-apple/remont-iphone/remont-iphone-6s-6splus/',
    'iphone-6-plus'     => '/service/remont-apple/remont-iphone/remont-iphone-6s-6splus/',
    'iphone-6s'         => '/service/remont-apple/remont-iphone/remont-iphone-6s-6splus/',
    'iphone-6s-plus'    => '/service/remont-apple/remont-iphone/remont-iphone-6s-6splus/',
    'iphone-7'          => '/service/remont-apple/remont-iphone/remont-iphone-7-7plus/',
    'iphone-7-plus'     => '/service/remont-apple/remont-iphone/remont-iphone-7-7plus/',
    'iphone-8'          => '/service/remont-apple/remont-iphone/remont-iphone-8-8plus/',
    'iphone-8-plus'     => '/service/remont-apple/remont-iphone/remont-iphone-8-8plus/',
    'iphone-se-2020'    => '/service/remont-apple/remont-iphone/remont-iphone-se-se2/',
    'iphone-se-2022'    => '/service/remont-apple/remont-iphone/remont-iphone-se-se2/',
    'iphone-x'          => '/service/remont-apple/remont-iphone/remont-iphone-x-xs-xsmax-xr/',
    'iphone-xr'         => '/service/remont-apple/remont-iphone/remont-iphone-x-xs-xsmax-xr/',
    'iphone-xs'         => '/service/remont-apple/remont-iphone/remont-iphone-x-xs-xsmax-xr/',
    'iphone-xs-max'     => '/service/remont-apple/remont-iphone/remont-iphone-x-xs-xsmax-xr/',
    'iphone-11'         => '/service/remont-apple/remont-iphone/remont-iphone-11-11pro-11promax/',
    'iphone-11-pro'     => '/service/remont-apple/remont-iphone/remont-iphone-11-11pro-11promax/',
    'iphone-11-pro-max' => '/service/remont-apple/remont-iphone/remont-iphone-11-11pro-11promax/',
    'iphone-12'         => '/service/remont-apple/remont-iphone/remont-iphone-12-12mini-12pro-12promax/',
    'iphone-12-mini'    => '/service/remont-apple/remont-iphone/remont-iphone-12-12mini-12pro-12promax/',
    'iphone-12-pro'     => '/service/remont-apple/remont-iphone/remont-iphone-12-12mini-12pro-12promax/',
    'iphone-12-pro-max' => '/service/remont-apple/remont-iphone/remont-iphone-12-12mini-12pro-12promax/',
    'iphone-13'         => '/service/remont-apple/remont-iphone/remont-iphone-13-13mini-13pro-13promax/',
    'iphone-13-mini'    => '/service/remont-apple/remont-iphone/remont-iphone-13-13mini-13pro-13promax/',
    'iphone-13-pro'     => '/service/remont-apple/remont-iphone/remont-iphone-13-13mini-13pro-13promax/',
    'iphone-13-pro-max' => '/service/remont-apple/remont-iphone/remont-iphone-13-13mini-13pro-13promax/',
    'iphone-14'         => '/service/remont-apple/remont-iphone/remont-iphone-14-14plus-14pro-14promax/',
    'iphone-14-plus'    => '/service/remont-apple/remont-iphone/remont-iphone-14-14plus-14pro-14promax/',
    'iphone-14-pro'     => '/service/remont-apple/remont-iphone/remont-iphone-14-14plus-14pro-14promax/',
    'iphone-14-pro-max' => '/service/remont-apple/remont-iphone/remont-iphone-14-14plus-14pro-14promax/',
    'iphone-15'         => '/service/remont-apple/remont-iphone/remont-iphone-15-15plus-15pro-15promax/',
    'iphone-15-plus'    => '/service/remont-apple/remont-iphone/remont-iphone-15-15plus-15pro-15promax/',
    'iphone-15-pro'     => '/service/remont-apple/remont-iphone/remont-iphone-15-15plus-15pro-15promax/',
    'iphone-15-pro-max' => '/service/remont-apple/remont-iphone/remont-iphone-15-15plus-15pro-15promax/',
    'iphone-16'         => '/service/remont-apple/remont-iphone/remont-iphone-16-16plus-16pro-16promax-16e/',
    'iphone-16e'        => '/service/remont-apple/remont-iphone/remont-iphone-16-16plus-16pro-16promax-16e/',
    'iphone-16-plus'    => '/service/remont-apple/remont-iphone/remont-iphone-16-16plus-16pro-16promax-16e/',
    'iphone-16-pro'     => '/service/remont-apple/remont-iphone/remont-iphone-16-16plus-16pro-16promax-16e/',
    'iphone-16-pro-max' => '/service/remont-apple/remont-iphone/remont-iphone-16-16plus-16pro-16promax-16e/',
    'iphone-17'         => '/service/remont-apple/remont-iphone/remont-iphone-17-17pro-17promax-air/',
    'iphone-17-air'     => '/service/remont-apple/remont-iphone/remont-iphone-17-17pro-17promax-air/',
    'iphone-17-pro'     => '/service/remont-apple/remont-iphone/remont-iphone-17-17pro-17promax-air/',
    'iphone-17-pro-max' => '/service/remont-apple/remont-iphone/remont-iphone-17-17pro-17promax-air/',
];
...
if (!empty($related_models)) {
    foreach ($related_models as $model_post) {
        ...
        $model_url = $model_url_map[$model_slug] ?? '';

        // Модели без URL — источники данных для issue selector, не показываются как плитки
        if (empty($model_url)) {
            if (empty($default_issue_model)) {
                $default_issue_model = $model_slug;
            }
            // Бренд не добавляем — плитки для этой модели не нужны
        } else {
            ...
            <ul class="tags-list" id="model-list">
                ...
                if (!empty($brands_data)):
                    ...
                    if (isset($models_by_brand[$first_brand_slug])):
                        ...
                        $is_popular = empty($popular_slugs) || in_array($model['slug'], $popular_slugs);
                        if (!$is_popular) $has_extra_models = true;
                ?>
                    <li class="model-item<?php echo !$is_popular ? ' model-item--extra' : ''; ?>" data-brand="<?php echo esc_attr($model['brand']); ?>"<?php echo !$is_popular ? ' style="display:none;"' : ''; ?>>
                        <a href="#" class="tag-link" data-model="<?php echo esc_attr($model['slug']); ?>"<?php if (!empty($model['url'])): ?> data-url="<?php echo esc_url($model['url']); ?>"<?php endif; ?>>
...
jQuery(document).ready(function($) {
    ...
    function updateAvailableIssues() {
        ...
        $issueList.children().each(function(i, el) {
            ...
            if (i >= _limit) { $(el).addClass('tag-extra').hide(); }
            else { $(el).show(); }
        });
        if (_btn) {
