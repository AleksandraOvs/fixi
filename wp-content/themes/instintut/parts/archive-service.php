        ...
        <div class="row auto-h">
            <div class="col-4">
                <div class="video__blue">
                    Ремонт с Fixibot — это просто.<br>Как мы работаем
                </div>
            </div>
            <div class="col-8">
                <a href="/wp-content/uploads/2026/02/process-remonta-zamena-kryshki-iphone-14-pro-max.mp4" class="video__in" data-fancybox="" data-type="video">
                    <img src="/wp-content/uploads/2026/02/video-700x394.jpg" alt="Как мы работаем — процесс ремонта">
                    <button class="video__btn">
                        <svg width="63" height="63" viewBox="0 0 63 63" fill="none" xmlns="http://www.w3.org/2000/svg">
                            <g clip-path="url(#clip0_video_arch)">
                            ...
                            <g clip-path="url(#clip1_video_arch)">
                            ...
                            <defs>
                                <clipPath id="clip0_video_arch">
                                    <rect width="63.0007" height="63.0007" fill="white" />
                                </clipPath>
                                <clipPath id="clip1_video_arch">
                                    <rect width="63.0007" height="63.0007" fill="white" />
                                </clipPath>
                            </defs>
                        </svg>
